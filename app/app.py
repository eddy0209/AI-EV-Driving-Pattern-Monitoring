...
st.write("""
This project demonstrates an AI-based Electric Vehicle optimization system capable of monitoring driving behaviour and dynamically optimizing energy consumption.
...
using AI-driven PWM optimization techniques.
""")
